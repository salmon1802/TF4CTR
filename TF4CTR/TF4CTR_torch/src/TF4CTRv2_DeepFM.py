...
# Full TF4CTR
class TF4CTRv2_DeepFM(BaseModel):
    def __init__(self,
                 feature_map,
                 model_id="TF4CTRv2_DeepFM",
                 gpu=-1,
                 learning_rate=1e-3,
                 embedding_dim=10,
                 c=0.8,
                 ...
                 **kwargs):
        super(TF4CTRv2_DeepFM, self).__init__(feature_map,
                                       model_id=model_id,
                                       gpu=gpu,
        ...
        self.easy_encoder = FactorizationMachine(feature_map)
    ...
    def forward(self, inputs):
        ...
        sim_encoder_out = self.easy_encoder(X, easy_out)
